About flake8-mutable-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-mutable-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/ebeweber/flake8-mutable
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2924&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-mutable-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-mutable` can be installed with `conda`:
...
```
mamba install flake8-mutable
```

It is possible to list all of the versions of `flake8-mutable` available on your platform with `conda`:
...
```
mamba search flake8-mutable --channel conda-forge
```
...
mamba repoquery search flake8-mutable --channel conda-forge

# List packages depending on `flake8-mutable`:
mamba repoquery whoneeds flake8-mutable --channel conda-forge

# List dependencies of `flake8-mutable`:
mamba repoquery depends flake8-mutable --channel conda-forge
```
